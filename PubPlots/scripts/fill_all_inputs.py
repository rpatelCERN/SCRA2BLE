...
def fill_all_inputs(lumi=35862.345):
   ...
   fill_qcdrs_hists('inputs/bg_hists/master-r+s-36.3.root', 'qcdrs_hists.root', 174) # CR lumi from JetHT V11: 36346.489
   fill_lostlep_hists('inputs/bg_hists/LLPrediction_HT5.root', 'lostlep_hists.root', 174) # CR lumi from MET V11: 35862.345
