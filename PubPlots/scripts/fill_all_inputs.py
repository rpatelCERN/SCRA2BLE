...
# CR lumi from single-electron V11: 36344.959
   ...
   if year==2016:
	...
	fill_qcdrs_hists('inputs/bg_hists/FullRun2/QcdPredictionRun2Final.root', 'qcdrs_hists.root', 174) # CR lumi from JetHT V11: 36346.489
	#fill_qcdrs_hists('inputs/bg_hists/FullRun2/QcdPredictionRun2.root', 'qcdrs_hists.root', 174) # CR lumi from JetHT V11: 36346.489
   	fill_znn_hists('inputs/bg_hists/FullRun2/ZinvHistos.root', 'znn_hists.root', 174) # CR lumi from single-electron V11: 36344.959
   	#fill_znn_hists('inputs/bg_hists/FullRun2/zinvData_2019Mar20_Run2//ZinvHistos.root', 'znn_hists.root', 174) # CR lumi from single-electron V11: 36344.959
   	#fill_znn_hists('inputs/bg_hists/FullRun2/zinvData_2019Feb22_Run2/ZinvHistos.root', 'znn_hists.root', 174) # CR lumi from single-electron V11: 36344.959
   	fill_hadtau_hists('inputs/bg_hists/FullRun2/InputsForLimits_data_formatted_LLPlusHadTau_CombinedYears_Yr2018_ModifiedSyst_Updated.root', 'lostlept_hists.root', 174) # CR lumi from single-muon V11: 36340.749
   	#fill_hadtau_hists('inputs/bg_hists/FullRun2/InputsForLimits_data_formatted_LLPlusHadTau_CombinedYears.root', 'lostlept_hists.root', 174) # CR lumi from single-muon V11: 36340.749
   	#fill_znn_hists('inputs/bg_hists/CrossCheck2016/zinvData_2019Mar20_2016/ZinvHistos.root', 'znn_hists.root', 174) # CR lumi from single-electron V11: 36344.959
   	...
   	#fill_postfit('inputs/bg_hists/FullRun2/fitDiagnosticstestCards-Moriond-T2bb_1000_550-137.4-mu0.0.root', 'postfit_hists.root',174)
   ...
   if year==2017:
	print(year)
   	#######10fb for 2017
   	fill_znn_hists('inputs/bg_hists/Run2017Inputs/zinvData_2019Mar20_2017/ZinvHistos.root', 'znn_hists.root', 174) # CR lumi from single-electron V11: 36344.959
   	fill_hadtau_hists('inputs/bg_hists/Run2017Inputs/InputsForLimits_data_formatted_LLPlusHadTau_Run2017.root', 'lostlept_hists.root', 174) # CR lumi from single-muon V11: 36340.749
   	fill_qcdrs_hists('inputs/bg_hists/Run2017Inputs/QcdPredictionRun2017.root', 'qcdrs_hists.root') # CR lumi from JetHT V11: 36346.489
   ...
   if year==2018:
	fill_qcdrs_hists('inputs/bg_hists/Run2018Inputs/QcdPredictionRun2018PreHem.root', 'qcdrs_hists.root', 174) # CR lumi from JetHT V11: 36346.489
   	fill_znn_hists('inputs/bg_hists/Run2018Inputs/zinvData_2019Mar20_2018AB/ZinvHistos.root', 'znn_hists.root', 174) # CR lumi from single-electron V11: 36344.959
   	fill_hadtau_hists('inputs/bg_hists/Run2018Inputs/NoHEM/InputsForLimits_data_formatted_LLPlusHadTau_PreHEMRecheck.root', 'lostlept_hists.root', 174) # CR lumi from single-muon V11: 36340.749
   	#fill_data_hists('inputs/data_hists/data_fixhtratio/RA2bin_signal.root', 'RA2bin_data2018', 'data_hists.root', 174)
   	#fill_znn_hists('inputs/bg_hists/Run2018Inputs/zinvData_2019Mar20_2018CD/ZinvHistos.root', 'znn_hists.root', 174) 
   	#fill_hadtau_hists('inputs/bg_hists/Run2018Inputs/HEM/InputsForLimits_data_formatted_LLPlusHadTau_PostHEMRecheck.root', 'lostlept_hists.root', 174) # CR lumi from single-muon V11: 36340.749
   	#fill_qcdrs_hists('inputs/bg_hists/Run2018Inputs/QcdPredictionRun2018DuringHem.root', 'qcdrs_hists.root', 174) # CR lumi from JetHT V11: 36346.489
