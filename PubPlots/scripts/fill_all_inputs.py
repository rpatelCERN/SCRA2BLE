...
##   fill_data_hists('inputs/data_hists/Data_combined_ICHEP_RUNG.root', 'RA2bin_data', 'data_hists.root', 174)
   ...
   fill_qcdrs_hists('inputs/bg_hists/QcdPredictionRandS_36.3.root', 'qcdrs_hists.root', 174, lumi/36346.489) # CR lumi from JetHT V11
   fill_lostlep_hists('inputs/bg_hists/LLPrediction.root', 'lostlep_hists.root', 174, lumi/36348.547) # CR lumi from MET V11
   fill_hadtau_hists('inputs/bg_hists/ARElog98_36.35ifb_HadTauEstimation_data_formatted_V11.root', 'hadtau_hists.root', 174, lumi/36340.749) # CR lumi from single-muon V11
   fill_signal_hists('signal_hists.root', 174)
   fill_qcd_hists('inputs/bg_hists/qcd-bg-combine-input-36.3ifb-dec16-dashes.txt', 'qcd_hists.root', 174, lumi/36348.547) # CR lumi from MET V11
