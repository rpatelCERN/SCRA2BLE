...
import make_12_asr_plot
from ROOT import TFile
from bg_est import BGEst
from data_obs import DataObs

def make_all_pas_plots_and_tables(lostlep_file = 'lostlep_hists.root', hadtau_file = 'hadtau_hists.root', znn_file = 'znn_hists.root', qcd_file = 'qcd_hists.root', data_file = 'data_hists.root'):
    ...
    make_12_asr_plot.make_12_asr_plot('results-plot-prefit-12-asrs-log', lostlep_12_asrs, hadtau_12_asrs, znn_12_asrs, qcd_12_asrs, data_obs_12_asrs)
    make_12_asr_plot.make_12_asr_plot('results-plot-prefit-12-asrs-log-pull', lostlep_12_asrs, hadtau_12_asrs, znn_12_asrs, qcd_12_asrs, data_obs_12_asrs, True)
