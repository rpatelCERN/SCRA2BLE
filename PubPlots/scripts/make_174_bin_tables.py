...
def make_174_bin_tables(output_file,  hadtau, znn, qcd, data_obs): #, 
    ...
    with open("/".join(["output", output_file+".tex"]), 'w') as fout:
        ...
        table0 = ResultsTable(data_obs,  hadtau, znn, qcd, 1, 30, \
        ...
        table1 = ResultsTable(data_obs,  hadtau, znn, qcd, 31, 70, \
        ...
        table2 = ResultsTable(data_obs,  hadtau, znn, qcd, 71, 110, \
        ...
        table3 = ResultsTable(data_obs,  hadtau, znn, qcd, 111, 142, \
        ...
        table4 = ResultsTable(data_obs,  hadtau, znn, qcd, 143, 174, \
...
if __name__ == "__main__": # to run from command line, just give the name of the BG estimation files
    ...
    f_hadtau = TFile.Open(sys.argv[2])
    ...
    make_160_bin_tables(output_file,  hadtau, znn, qcd, data_obs) # , sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5]  
