...
def make_1D_postfitprojection(plot_title, asr_name, postfit_file, data_file, signal_file, \
    ...
    f_post=open_if_necessary(postfit_file)
    ...
    tot_proj = BGEst(f_post.Get(asr_name+"/hCV"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hSystUp"), f_post.Get(asr_name+"/hSystUp"), 2001)
    qcd_proj = BGEst(f_post.Get(asr_name+"/hQCDCV"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hQCDSysUp"), f_post.Get(asr_name+"/hQCDSysUp"), 2001)
    znn_proj = BGEst(f_post.Get(asr_name+"/hZCV"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hZSysUp"), f_post.Get(asr_name+"/hZSysUp"), 2002)
    lostlept_proj = BGEst(f_post.Get(asr_name+"/hWTopCV"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hStatUp"), f_post.Get(asr_name+"/hWTopSysUp"), f_post.Get(asr_name+"/hWTopSysUp"), 2006)

    TotalBkg=f_post.Get(asr_name+"/hCV")
    hqcd = qcd_proj.hCV
    hznn = znn_proj.hCV
