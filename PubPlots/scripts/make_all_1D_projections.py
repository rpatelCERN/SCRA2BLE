...
def make_all_1D_projections(lostlep_file = 'lostlep_hists.root', hadtau_file = 'hadtau_hists.root', znn_file = 'znn_hists.root', qcd_file = 'qcdrs_hists.root', data_file = 'data_hists.root', signal_file = 'signal_hists.root'):
    ...
    make_1D_projection('T1tttt-projection-pull', 'T1tttt', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
    ...
    make_1D_projection('T1bbbb-projection-pull', 'T1bbbb', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
    ...
    make_1D_projection('T1qqqq-projection-pull', 'T1qqqq', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
    ...
    make_1D_projection('T2tt-projection-pull', 'T2tt', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
    ...
    make_1D_projection('T2bb-projection-pull', 'T2bb', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
    ...
    make_1D_projection('T2qq-projection-pull', 'T2qq', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
    ...
    make_2D_projection('2D-T1bbbb', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T1bbbb_1500_100", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV")
    make_2D_projection('2D-T1qqqq', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T1qqqq_1400_100", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV")
    make_2D_projection('2D-T2tt', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T2tt_700_50", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV")
    make_2D_projection('2D-T2bb', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T2bb_650_1", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV")
    make_2D_projection('2D-T2qq', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T2qq_1000_100", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV")
    make_2D_projection('2D-T1tttt-pull', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T1tttt_1500_100", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV", doPull=True)
    make_2D_projection('2D-T1bbbb-pull', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T1bbbb_1500_100", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV", doPull=True)
    make_2D_projection('2D-T1qqqq-pull', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T1qqqq_1400_100", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV", doPull=True)
    make_2D_projection('2D-T2tt-pull', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T2tt_700_50", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV", doPull=True)
    make_2D_projection('2D-T2bb-pull', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
                       "T2bb_650_1", "H_{T}^{miss} > 750 GeV, H_{T} > 750 GeV", doPull=True)
    make_2D_projection('2D-T2qq-pull', '2D', lostlep_file, hadtau_file, znn_file, qcd_file, data_file, signal_file, \
