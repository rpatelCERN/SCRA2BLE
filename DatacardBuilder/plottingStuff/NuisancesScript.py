...
os.system('python diffNuisances.py ../mlfittestCards-allBkgswithPho-SMSbbbb1500-2.1-mu0.0.root -o NUIS_SMSbbbb1500.txt');
os.system('python QuickNuisPlot.py NUIS_SMSbbbb1500 -b');

# os.system('python diffNuisances.py -a ../mlfittestCards-allBkgs-SMSbbbb1000-2.1-mu0.0.root -o NUIS_SMSbbbb1000.txt');
