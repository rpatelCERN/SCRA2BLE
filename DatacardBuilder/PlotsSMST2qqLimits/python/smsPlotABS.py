...
class smsPlotABS(object):
	...
	self.emptyHisto.GetXaxis().SetNdivisions(5,5,2)
	...
	CMS_lumi.CMS_lumi(self.c,4, iPos)
        ...
        textNLONLL.Draw()
        text1Squark= rt.TLatex(0.22,0.45,"Single #tilde{q}")
        text1Squark.SetNDC()
        text1Squark.SetTextAlign(13)
        text1Squark.SetTextFont(42)
        text1Squark.SetTextSize(0.035)
        text1Squark.Draw()
        self.c.text1Squark = text1Squark
        text8Squark= rt.TLatex(0.4,0.65,"#tilde{q}_{L} + #tilde{q}_{R} ( #tilde{u}, #tilde{d}, #tilde{s}, #tilde{c} )")
        text8Squark.SetNDC()
        text8Squark.SetTextAlign(13)
        text8Squark.SetTextFont(42)
        text8Squark.SetTextSize(0.04)
        text8Squark.Draw()
    ...
    def DrawLegend(self):
        ...
        textExp = rt.TLatex(self.model.Xmin+11*xRange/100, self.model.Ymax-2.15*yRange/100*10+offset, 
                            "Expected #pm 1, #pm 2 #sigma_{experiment}")
    ...
    def DrawLines(self):
        ...
        self.EXP['plus2sigma'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['plus2sigma'].SetLineStyle(2)
        self.EXP['plus2sigma'].SetLineWidth(2)                
        # expected
        ...
        self.EXP['minus2sigma'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['minus2sigma'].SetLineStyle(2)
        self.EXP['minus2sigma'].SetLineWidth(2)                        

        # observed
        self.OBS['nominal2'].SetLineColor(color(self.OBS['colorLine']))
        self.OBS['nominal2'].SetLineStyle(1)
        self.OBS['nominal2'].SetLineWidth(4)
        # observed + 1sigma
        self.OBS['plus2'].SetLineColor(color(self.OBS['colorLine']))
        self.OBS['plus2'].SetLineStyle(1)
        self.OBS['plus2'].SetLineWidth(2)        
        # observed - 1sigma
        self.OBS['minus2'].SetLineColor(color(self.OBS['colorLine']))
        self.OBS['minus2'].SetLineStyle(1)
        self.OBS['minus2'].SetLineWidth(2)        
        # expected + 1sigma
        self.EXP['plus2'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['plus2'].SetLineStyle(7)
        self.EXP['plus2'].SetLineWidth(2)                
        self.EXP['plus2sigma2'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['plus2sigma2'].SetLineStyle(2)
        self.EXP['plus2sigma2'].SetLineWidth(2)                
        # expected
        self.EXP['nominal2'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['nominal2'].SetLineStyle(7)
        self.EXP['nominal2'].SetLineWidth(4)        
        # expected - 1sigma
        self.EXP['minus2'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['minus2'].SetLineStyle(7)
        self.EXP['minus2'].SetLineWidth(2)                        
        self.EXP['minus2sigma2'].SetLineColor(color(self.EXP['colorLine']))
        self.EXP['minus2sigma2'].SetLineStyle(2)
        self.EXP['minus2sigma2'].SetLineWidth(2)                        


        # DRAW LINES
        self.EXP['nominal'].Draw("LSAME")
        self.EXP['plus'].Draw("LSAME")
        self.EXP['plus2sigma'].Draw("LSAME")
        self.EXP['minus'].Draw("LSAME")
        self.EXP['minus2sigma'].Draw("LSAME")
        self.OBS['nominal'].Draw("LSAME")
        self.OBS['plus'].Draw("LSAME")
        self.OBS['minus'].Draw("LSAME")        
       
        self.EXP['nominal2'].Draw("LSAME")
        self.EXP['plus2'].Draw("LSAME")
        self.EXP['plus2sigma2'].Draw("LSAME")
        self.EXP['minus2'].Draw("LSAME")
        self.EXP['minus2sigma2'].Draw("LSAME")
        self.OBS['nominal2'].Draw("LSAME")
        self.OBS['plus2'].Draw("LSAME")
        self.OBS['minus2'].Draw("LSAME")        
