...
def LeptonCorr(signaldirtag,model,lumi, mGo, mLSP): #Here you can also add the genMHT hist
	...
	if "T1tbtb" in model or "T1tbtbT1tbttT1tttt" in model or "T1tbtbT1tbbbT1bbbb" in model or "T1ttbb" in model:
		...
		if "T1tbtb" in model:
                	...
                	TauGenHist=signalContamTau_T1tbtb.Get("SignalContamination/mGluino_%d_mLSP_%d" %(mGo, mLSP))
		...
		if "T1tbtbT1tbttT1tttt" in model:
                	...
                	TauGenHistT1tbtb=signalContamTau_T1tbtb.Get("SignalContamination/mGluino_%d_mLSP_%d" %(mGo, mLSP))
                	...
                	TauGenHistT1tbtt=signalContamTau_T1tbtt.Get("SignalContamination/mGluino_%d_mLSP_%d" %(mGo, mLSP))
                	...
                	TauGenHistT1tttt=signalContamTau_T1tttt.Get("SignalContamination/mGluino_%d_mLSP_%d" %(mGo, mLSP))
		...
		if "T1tbtbT1tbbbT1bbbb" in model:
                	...
                	TauGenHistT1tbbb=signalContamTau_T1tbbb.Get("SignalContamination/mGluino_%d_mLSP_%d" %(mGo, mLSP))
		...
		if "T1ttbb" in model:
                	...
                	TauGenHistT1bbtt=signalContamTau_T1bbtt.Get("SignalContamination/mGluino_%d_mLSP_%d" %(mGo, mLSP))
