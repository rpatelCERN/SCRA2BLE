...
class smsPlotABS(object):
	...
	self.emptyHisto.GetXaxis().SetNdivisions(4,5,0)
        # set y axis
	...
	self.preliminary="Supplementary"
        textCMS = rt.TLatex(0.25,0.96,"  Simulation %s " %(self.preliminary))
        textCMS.SetNDC()
	...
	diagonal.SetPoint(diagonal.GetN(), 150,150-25);
